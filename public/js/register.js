  ...
  _createClass(FormValidation, [{
    ...
    value: function initEvents() {
      ...
      this.element.addEventListener('submit', function (e) {
        _this.actions.forEach(function (el) {
          if (el.dataset.action === 'change') {
            ...
            if (el.dataset.condition) {
              var condition = _this.element.querySelector("[name=\"".concat(el.dataset.condition, "\"]"));
        ...
        if (_this.element.checkValidity() === false) {
          e.preventDefault();
          e.stopPropagation();
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).unbind('submit').submit();
        }

        _this.element.classList.add('was-validated');
      }, false);

      var inputCount = _toConsumableArray(this.actions).reduce(function (a, b) {
        return b.dataset.action === 'input' ? a + 1 : a;
      }, 0);

      if (inputCount) {
        this.element.addEventListener('input', function (_) {
          _this.actions.forEach(function (el) {
            if (el.dataset.condition) {
              var condition = document.querySelector("[name=\"".concat(el.dataset.condition, "\"]"));
              el.setCustomValidity(el.value != condition.value ? el.dataset.text : "");
            } else {
              el.setCustomValidity(el.value === "" ? el.dataset.text : "");
            }
      ...
      var changeCount = _toConsumableArray(this.actions).reduce(function (a, b) {
...
module.exports = __webpack_require__(/*! /Users/jimcallanta/Sites/kredo/resources/js/register.js */"./resources/js/register.js");
