        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <dl>
                  <dt>Prefecture</dt>
                  <dd>
                    <a href="{{ route('employee.employees.index', ['prefecture' => $employee->prefecture]) }}">
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('employee.employees.index', ['status' => $employee->status]) }}">
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('employee.employees.index', ['country' => $employee->country]) }}">
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('employee.employees.index', ['position_id' => $employee->position_id]) }}">
                  {{ $employee->position }}
                </a>
              </td>
            </tr>
