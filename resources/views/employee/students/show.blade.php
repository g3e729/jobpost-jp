          ...
          <div class="card-body">
            ...
            <div class="card-body-main mt-3">
              ...
              <div class="card-badges text-center h6">
                ...
                <a href="{{ route('employee.students.index', ['course_id' => $student->course_id]) }}"><span class="badge badge-pill badge-secondary">コース : {{ $student->course }}</span></a>
                <span class="badge badge-pill badge-secondary">ステータス : {{ $student->student_status }}</span>
                <a href="{{ route('employee.students.index', ['english_level_id' => $student->english_level_id]) }}"><span class="badge badge-pill badge-secondary">英語 : {{ $student->english_level }}</span></a>
              </div>
