  ...
  <form class="form-login needs-validation pt-4 pb-3 pr-5 mb-3" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group mt-3 mb-4 js-password-group">
      ...
      <div class="input-group">
        <input id="password" type="password" class="form-control rounded-0 @error('password') is-invalid @enderror border-right-0" name="password" required autocomplete="current-password">
