...
<nav class="navbar-nav sidebar sidebar-gradient accordion" id="accordionSidebar">
  ...
  <ul class="nav">
    <li class="nav-item {{ request()->is('admin/students*') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/companies*') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/employees*') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/recruitments*') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/notifications*') && !request()->is('admin/notifications/create') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/messages*') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/invite*') || request()->is('admin/notifications/create') ? 'active bg-light' : ''}}">
    ...
    <li class="nav-item {{ request()->is('admin/payments*') || request()->is('admin/tickets*') ? 'active bg-light' : ''}}">
