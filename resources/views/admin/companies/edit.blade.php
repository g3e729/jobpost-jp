          ...
          <div class="tab-pane fade show active" id="pills-basic" role="tabpanel" aria-labelledby="pills-basic-tab">
            <form id="editForm" class="needs-validation py-2 mb-4" method="POST" action="" novalidate>
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="text" class="form-control" id="formCompanyName" name="company_name" value="{{ $company->company_name }}" placeholder="" required>
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <textarea class="form-control" id="formIntro" name="description" placeholder="" rows="4" style="min-height: 100px;" required>{{ $company->description }}</textarea>
                  <div class="invalid-tooltip">
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="url" class="form-control" id="formHomepage" name="homepage" value="{{ $company->homepage }}" placeholder="" required>
                  <div class="invalid-tooltip">
              ...
              <div class="pb-3 row">
                ...
                <div class="col-9">
                  <div class="form-group position-relative">
                    ...
                    <select class="form-control" id="formPrefecture" name="prefecture" data-action="change"
                      ...
                      @foreach($prefectures as $index => $name)
                        <option value="{{ $index }}" {{ ($index == $company->prefecture) ? 'selected' : null }}>{{ $name }}</option>
                      @endforeach
                    </select>
                    <div class="invalid-tooltip">
                  ...
                  <div class="form-group position-relative">
                    ...
                    <input type="text" class="form-control" id="formAddress1" name="address1" value="{{ $company->address1 }}" placeholder="" required>
                    <div class="invalid-tooltip">
                  ...
                  <div class="form-group position-relative">
                    ...
                    <input type="text" class="form-control" id="formAddress2" name="address2" value="{{ $company->address2 }}" placeholder="" required>
                    <div class="invalid-tooltip">
                  ...
                  <div class="form-group position-relative">
                    ...
                    <input type="number" class="form-control" id="formAddress3" name="address3" value="{{ $company->address3 }}" placeholder="" required>
                    <div class="invalid-tooltip">
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="text" class="form-control" id="formCeo" name="ceo" value="{{ $company->ceo }}" placeholder="" required>
                  <div class="invalid-tooltip">
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="number" class="form-control" id="formNumberOfEmployees" name="number_of_employees" min="1" value="{{ $company->number_of_employees }}" placeholder="" required>
                  <div class="invalid-tooltip">
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <div class="input-group">
                    <input type="text" class="form-control js-datepicker" id="formEstablishedDate" name="established_date" value="{{ $company->established_date->format('Y-m-d') }}" placeholder="" required>
                ...
                <div class="col-9">
                  <select class="form-control" id="formIndustryId" name="industry_id" data-action="change" data-condition="" data-text="Please choose your industry.">
                    ...
                    @foreach($industries as $index => $name)
                      <option value="{{ $index }}" {{ ($index == $company->industry_id) ? 'selected' : null }}>{{ ucwords($name) }}</option>
                    @endforeach
                  </select>
                  <div class="invalid-tooltip">
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="url" class="form-control" id="formFacebook" name="facebook" value="{{ $company->facebook }}" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="url" class="form-control" id="formTwitter" name="twitter" value="{{ $company->twitter }}" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9">
                  <input type="url" class="form-control" id="formInstagram" name="instagram" value="{{ $company->instagram }}" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9" data-group="avatar">
                  ...
                  <div class="input-group">
                    <input data-avatar="name" type="text" class="form-control" value="{{ $company->avatar ?? null }}" disabled required>
                    <div class="input-group-append">
                  ...
                  <div class="mt-3">
                    <img data-avatar="preview" class="avatar avatar-md border border-secondary my-3" src="{{ $company->avatar ?? 'https://placehold.it/80x80' }}">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group pb-3 row">
                ...
                <div class="col-9" data-group="eyecatch">
                  <input data-avatar="file" type="file" class="form-control-file" id="formCoverPhoto" name="cover_photo" accept="image/png, image/jpeg" style="visibility: hidden; position: absolute;">
                  <div class="input-group">
                    <input data-avatar="name" type="text" class="form-control" value="{{ $company->cover_photo ?? null }}" disabled required>
                    <div class="input-group-append">
                      <button data-avatar="browse" type="button" class="alt-font btn btn-primary">Browse</button>
                    </div>
                    <div class="invalid-tooltip">
                  ...
                  <div class="mt-3">
                    <img data-avatar="preview" class="img-fluid border border-secondary my-3" src="{{ $company->cover_photo ?? 'https://placehold.it/80x80' }}">
                  </div>
